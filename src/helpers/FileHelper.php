...
class FileHelper extends BaseFileHelper
{
     ...
     * @inheritdoc
     */
    public static function cropImage($imagePath, $imageName, $prefix, $croppingData) {
        $src = $imagePath . $imageName;
        $dst = $imagePath . $prefix . $imageName;
        ...
        $result = imagecopyresampled($dst_img, $src_img, 0, 0, $croppingData -> x, $croppingData -> y, $width, $height, $width, $height);
